...
class WooTumblog {
	...
	function WooTumblog() {
		...
		update_option('woo_tumblog_version', '2.1.4');
	...
	function woo_tumblog_header_code() {
		...
		//Audio Player
		echo '<script type="text/javascript" src="'.get_tumblog_url() .'functions/swfobject.js"></script>';
		//Frontend styles
		echo '<link rel="stylesheet" type="text/css" media="all" href="'.get_tumblog_url() .'functions/css/tumblog_frontend_styles.css" />';
