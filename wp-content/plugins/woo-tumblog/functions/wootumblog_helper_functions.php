	...
	function woo_tumblog_image($args) {
		...
		elseif ( get_option('woo_resize') == 'true') {
			...
			foreach($src_arr as $key => $custom_field){
				...
				$img_link = '<img src="'. get_tumblog_url(). 'functions/thumb.php?src='. $custom_field .'&amp;w='. $width .'&amp;h='. $height .'&amp;zc=1&amp;q='. $quality . $alignment . '" '.$alt.' class="'. stripslashes($class) .'" '. $set_width . $set_height . ' />';
